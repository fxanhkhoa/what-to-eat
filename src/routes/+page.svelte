...
<section id="meal-category" class="bg-white px-10 md:px-32 relative">
	<div
		class="grid grid-cols-12 gap-5 -translate-y-20 bg-white rounded-lg p-5 md:p-10 shadow-lg drop-shadow-xl">
		<div
