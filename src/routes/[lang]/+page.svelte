<script lang="ts">
	...
	import WheelOfFortune from '$lib/components/wheel-of-fortune.svelte';
	...
	<div class="grid grid-cols-12 place-items-center">
		<div class="col-span-12 md:col-span-6 flex flex-col gap-5">
			...
			<a
				...
				<span
					class="relative uppercase transition-colors duration-300 delay-200 group-hover:text-white ease font-semibold"
	...
	<div
		...
		<div
			...
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="breakfast" src={breakfast} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="lunch" src={lunch} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="brunch" src={brunch} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="dinner" src={dinner} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="salad" src={salad} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="burger" src={burger} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="soup" src={soup} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="appetize" src={appetize} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="dessert" src={dessert} class="object-cover rounded-full w-16 h-16" />
			</div>
		...
		<div
			class="col-span-4 md:col-span-3 flex flex-col justify-center items-center gap-1 cursor-pointer group">
			<div class="p-3 bg-gray-100 rounded-full group-hover:bg-gray-300 duration-300 ease-in-out">
				<img alt="hotpot" src={hotpot} class="object-cover rounded-full w-16 h-16" />
			</div>
			<h4 class="font-bold">{$_('hot-pot')}</h4>
		</div>
	</div>
	<div class="flex justify-center">
		<button class="-translate-y-24 text-center bg-gray-300 p-3 w-12 h-12 rounded-full"
			><i class="fa-solid fa-angles-down" /></button>
	</div>
</section>

<section id="food-category" class="bg-white px-10 md:px-32 pt-10">
	<div class="flex flex-col gap-5 md:gap-10">
		<h1 class="text-center font-bold text-black">{$_('categories')}</h1>
		<h5 class="text-justify text-gray-500">{$_('category.subtitle')}</h5>
